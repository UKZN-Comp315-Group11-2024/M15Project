...
namespace M15Namespace {
	...
	public:
		...
		popup2(String^ text, int x, int y, String^ backgroundImage, String^ nextLevel)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(popup2::typeid));
			   ...
			   this->lblText->Click += gcnew System::EventHandler(this, &popup2::lblText_Click);
			   // 
			   // timertext
			   // 
			   this->timertext->Interval = 30;
			   this->timertext->Tick += gcnew System::EventHandler(this, &popup2::timertext_Tick);
			   // 
			   // lblspace
			   // 
			   ...
			   this->timerclose->Tick += gcnew System::EventHandler(this, &popup2::timerclose_Tick);
			   // 
			   ...
			   this->Text = L"popup";
			   this->Load += gcnew System::EventHandler(this, &popup2::popup_Load);
			   this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &popup2::popup_KeyDown);
...
#pragma endregion
	...
	private: System::Void popup_KeyDown(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e) {
		...
		{
			if (context.marshal_as<std::string>(this->nextLevel) == "level 1") {
				PlaySound(NULL, NULL, 0);
				lvl1Form^ window = gcnew lvl1Form();
